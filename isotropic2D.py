...
def mesh_isotropic_2D(input_folder, mesh_name, \
    patch_permittivity, matrix_permittivity, air_permittivity):
    """Read mesh and subdomains, from .h5 mesh file, for
        heterogeneous isotropic domain"""
...
if __name__ == "__main__":
    ...
    # Function call: python3 isotropic2D.py input_folder
    #   mesh_name output_folder FF_n
    # ie. python3 isotropic2D.py mesh isotropic results 72
    ...
    # Mesh function
    mesh, markers, permittivity = mesh_isotropic_2D(input_folder, mesh_name, \
        patch_permittivity, matrix_permittivity, air_permittivity)
    ...
    phi, FF = ff_isotropic_2D(mesh_name, output_folder, permittivity, \
